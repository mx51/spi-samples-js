...
- [FE-20](https://mx51.atlassian.net/browse/FE-20) Add cloud pairing transaction initialisation

## [1.7.15] - 2024-11-04

## Added

- [FE-19](https://mx51.atlassian.net/browse/FE-19) Add unpairing functionality to SPI Cloud pairings table

## [1.7.14] - 2024-10-16

### Fixed

- [INTG-1037](https://mx51.atlassian.net/browse/INTG-1037) Remove test pairing from SPI Cloud pairings table

## [1.7.13] - 2024-10-10

### Added

- [INTG-1037](https://mx51.atlassian.net/browse/INTG-1037) Add SPI Cloud pairings table
