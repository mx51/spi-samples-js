              ...
              <div className="padding-1">
                <form name="pairing" id="pairing-form">
                  ...
                  <fieldset id="paring-buttons">
                    ...
                    <button disabled type="button" className="action" id="pair_confirm" title="Confirm Pairing Code">
                      Confirm Code
                    </button>
                ...
                <form id="action-form" name="controls">
                  <fieldset id="action-buttons">
                    ...
                    <button disabled type="button" className="action" id="table" title="Print current bill for a table">
                      Get table bill
                    </button>
                  ...
                  <fieldset id="action-inputs">
                    ...
                    <table className="form">
                      ...
                      <tr className="input-field-group hidden" data-id="enabled">
                        ...
                        <td>
                          <input className="input" type="checkbox" id="enabled" name="enabled" defaultValue="false" />
                        </td>
                      </tr>
